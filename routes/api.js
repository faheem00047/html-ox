...
router.get('/photooxy/cup', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/write-text-on-the-cup-392.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/wolf-metal', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/create-a-wolf-metal-text-effect-365.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/glass', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/online-3d-white-stone-text-effect-utility-411.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/crisp-chrome', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/create-a-crisp-chromed-text-effect-196.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/quotes', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/quotes-under-fall-leaves-347.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/love-message', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/romantic-messages-for-your-loved-one-391.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/burn-paper', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/write-text-on-burn-paper-388.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/funny-cup', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/put-text-on-the-cup-387.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/double-heart', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/love-text-effect-372.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/quote-wood', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/write-art-quote-on-wood-heart-370.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/flower-heart', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/text-inside-the-flower-heart-369.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/wooden-board', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/writing-on-wooden-boards-368.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/summer', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/3d-summer-text-effect-367.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/nature', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/make-nature-3d-text-effects-364.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/water', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/creating-an-underwater-ocean-363.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/golden-rose', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/yellow-roses-text-360.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/nature-summer', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/create-vector-nature-typography-355.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/letter-leaves', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/create-a-layered-leaves-typography-text-effect-354.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/gridiant-avatar', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/gradient-avatar-text-effect-207.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/rainbow-glow', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/glow-rainbow-effect-generator-201.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/fur-text', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/fur-text-effect-generator-198.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/embroidery-text', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/create-embroidery-text-online-191.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/3d-rainbow', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/other-design/create-3d-text-on-rainbow-online-189.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/material-text', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/multi-material-text-effect-184.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/quotes-3', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/quotes-under-fall-leaves-347.html", [text1])
    .then((data) => {
...
router.get('/photooxy/arced-rafit', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
var text2 = req.query.text
  if (!text2) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/8-bit-text-on-arcade-rift-175.html", [text1,text2])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/coffie-logo', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/put-your-text-on-a-coffee-cup--174.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/smoke', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/smoke-typography-text-effect-170.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/silk', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/simple-text-on-the-silk-167.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/royal-patterns', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/bevel-text-between-royal-patterns-166.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/flower-orchid', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/text-under-flower-165.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/neon', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/create-party-neon-text-effect-161.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/dark-metal', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/other-design/create-dark-metal-text-with-special-logo-160.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/green-text', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/make-great-quotes-on-nature-211.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/modern-metal', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/create-wallpaper-with-modern-metal-text-179.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/war-face', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/fps-game-effect/make-avatar-challenges-warface-155.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/fps-game', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  var text2 = req.query.text
  if (!text2) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/fps-game-effect/create-battlefield-4-rising-effect-152.html", [text1,text2])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/pokemon', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/movies/make-pokemon-wallpaper-with-your-name-149.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/photooxy/cake', async (req, res, next) => {
  var text1 = req.query.text
  if (!text1) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  alip.photooxy("https://photooxy.com/logo-and-text-effects/text-on-appy-birthday-cake-190.html", [text1])
    .then((data) => {
      res.set({ 'Content-Type': 'image/png' })
      res.send(data)
    })
...
router.get('/images/videoanime', async (req, res, next) => {
  var mp41 = req.query.mp4
  if (!mp41) return res.json({ status: false, creator: `${creator}`, message: "[!] masukan parameter text" })
  if (mp41.length > 2048) return res.json({ status: false, creator: `${creator}`, message: "[!] Maximal 2.048 String!" })

  res.json({
    status: true,
    creator: `${creator}`,
    result: Buffer.from(mp41).toString('base64')
  })
