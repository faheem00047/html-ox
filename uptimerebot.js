...
const myMonitor = new Monitor({
    address: 'https://a6d3ce35-0ea9-4f20-80fc-ff30378803ae-00-2p8hpoa1o7yl1.teams.replit.dev',//change the ip address of the web to run the bot or leave 127.0.0.1 also known as localhost nha bruh( just for pro 🐧)
    port: 8080, //port bot 
    interval: 10, // 10 giây
  config: {
